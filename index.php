	...
	<body class="bgcolor-1">
		<div class="container">
			...
			<section class="content">
				...
				<p>with <i class="fa fa-heart" style="font-size:24px;color:red"></i>from <a href="http://www.iitg.ac.in/scifac/cep/public_html/index.html" target="_blank">cepstrum.</a></p>
			</section>
		</div><!-- /container -->
